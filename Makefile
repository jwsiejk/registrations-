...
help:
	...
	@echo "  make docker-tls-setup            # Generate local TLS assets for Postgres services"
...
docker-tls-setup:
	bash infra/docker/scripts/generate-tls-certs
